...
if (window.dcl===undefined){
    function dcl(s) { console.log(s); }
}
if (window.dco===undefined)   {
        function dco(s,r) { console.log(dairy_farm_debug_object(s,false,r)); }
}
if (window.dal===undefined) 
{
    function dal(s) { if (DAIRY_FARM_STORAGE['user_logged_in']) alert(s); }
}
if (window.dao===undefined) 
{
    function dao(s,h,r) { if (DAIRY_FARM_STORAGE['user_logged_in']) alert(dairy_farm_debug_object(s,h,r)); }
}
if (window.ddl===undefined) 
{
    function ddl(s) { dairy_farm_debug_log(s); }
}
if (window.ddo===undefined) 
{
    function ddo(s,h,r) { dairy_farm_debug_log(dairy_farm_debug_object(s,h,r)); }
}
